...
VALUES
('James','Fraser','jf@godenbough.edu'),
('Jack','London','jlondon@uslaska.edu'),
('Robert','Brunce','rbruce@soctland.net'),
('Peter','Greenaway','pgreenway@postmodern.com'),
('Derek','Jarman','djarman@prospectcottage.net'),
('Paolo','Pasolini','ppasolini@salo.com'),
('Heathcote','Williams','hwilliams@bafta.com'),
('Sandy','Powell','spowell@osacars.com'),
